  ...
  return (
    <>
      ...
      >
        ...
        >
          <g>
            <rect
              width={clientWidth}
              // height={clientHeight - (clientHeight / 100) * 10}
              height={clientHeight}
              fill="white"
            ></rect>
            <rect width="16.666666667%" height="90%" fill="#F9F7EF"></rect>
            <rect
              y="90%"
              width="16.666666667%"
              height="10%"
      ...
      <chakra.div
        ...
        zIndex={20}
      >
        <chakra.div position="relative" backgroundColor="rgb(48, 48, 48)">
          {/* content */}
          <chakra.div
            position="relative"
            width="100%"
          ...
          >
            ...
            {/* scroll thingy */}
            <chakra.div
              bottom={{ base: '40px', md: 'auto' }} // md = smlaptop
              width="100%"
              zIndex={999999}
              display="flex"
              flexDirection="column"
          ...
          >
            ...
            >
              ...
              >
                The Lotus Gang collection contains 2,000 Lads and 2,000 Ladies
                in 32x32 pixel art which give you access to our ongoing projects
            ...
            >
              ...
              >
                ...
                collection was hand-drawn by Bunjil who is the founder and
                artist behind The Lotus.
              </chakra.p>
            ...
            >
              <chakra.div>
                ...
                <chakra.p
                  ...
                  lineHeight={{ lg: '1.75rem' }}
                >
                  <chakra.span fontStyle="italic">Sources</chakra.span> say this
                  is the best merch in Web3. Each purchase comes with a bag of
                  goodies.
                </chakra.p>
